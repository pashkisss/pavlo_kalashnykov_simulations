...
Модель **Wolf Sheep Predation** описує взаємодію двох популяцій — овець (жертв) та вовків (хижаки) — у середовищі з ресурсом (травою).  
Овці рухаються випадково та отримують енергію, поїдаючи траву.  
Вовки отримують енергію, лише поїдаючи овець.  

Кожен агент:

- рухається випадковим чином;  
- витрачає енергію на кожному тіку;  
- може розмножуватися з певною ймовірністю;  
- помирає при вичерпанні енергії;  
- взаємодіє з травою (овці) або іншими агентами (вовки).

Модель демонструє класичні коливання хижака та жертви, можливість вимирання одного або обох видів та складне ресурсне самообмеження.
